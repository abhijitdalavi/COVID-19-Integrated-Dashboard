...
class ChatBot:
    ...
    def __init__(self):
        ...
        self.store_synonyms()
        self.reset_flags()
        print("Press Ctrl + C to close the chatbot")
        try:
            while(True):
                self.reset_flags()
                user_input = input("You: ")
                preprocessed_input = self.preprocess_input(user_input)
                self.set_flags(preprocessed_input)
                print("Bot:", self.reply(preprocessed_input))
    ...
    def store_synonyms(self):
        ...
        self.general_prevention_words = self.give_synonyms('precaution', 'precautions', 'prevent')
        ...
        self.incubation_words = self.give_synonyms('incubation', 'period', 'duration', 'incubate')
    ...
    def reply(self, preprocessed_tokens):
